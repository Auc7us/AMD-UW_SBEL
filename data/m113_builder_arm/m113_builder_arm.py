...
shapes_dir = 'm113_builder_arm_shapes/' 
...
contact_material.SetYoungModulus(2e7)
contact_material.SetPoissonRatio(0.3)
contact_material.SetKn(2e5)
contact_material.SetGn(40.0)
contact_material.SetKt(2e5)
contact_material.SetGt(20.0)
